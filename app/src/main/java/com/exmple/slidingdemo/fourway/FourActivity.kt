    ...
    private fun initViewPager() {
        ...
        commonNavigator.adapter = object : CommonNavigatorAdapter() {
            override fun getTitleView(p0: Context?, p1: Int): IPagerTitleView {
                val simplePagerTitleView = SimplePagerTitleView(this@FourActivity)//设置为可渐变的View
                if (p1 == 0) {
                    simplePagerTitleView.text = "new"
                } else {
                    simplePagerTitleView.text = "hot"
                }
                simplePagerTitleView.textSize = 18f
                simplePagerTitleView.normalColor = Color.parseColor("#676463")
                simplePagerTitleView.selectedColor = ContextCompat.getColor(this@FourActivity, R.color.barcolor)
            ...
            override fun getIndicator(p0: Context?): IPagerIndicator {
                val linePagerIndicator = LinePagerIndicator(this@FourActivity)
                linePagerIndicator.setColors(ContextCompat.getColor(this@FourActivity, R.color.barcolor))//线的颜色
                linePagerIndicator.mode = 2
                linePagerIndicator.lineHeight = UIUtil.dip2px(this@FourActivity, 2.0).toFloat()
                linePagerIndicator.lineWidth = UIUtil.dip2px(this@FourActivity, 15.0).toFloat()
                linePagerIndicator.roundRadius = UIUtil.dip2px(this@FourActivity, 1.0).toFloat()
        ...
        commonNavigator2.adapter = object : CommonNavigatorAdapter() {
            override fun getTitleView(p0: Context?, p1: Int): IPagerTitleView {
                ...
                simplePagerTitleView.textSize = 18f
                simplePagerTitleView.normalColor = ContextCompat.getColor(this@FourActivity, R.color._BCBCBC)
                simplePagerTitleView.selectedColor = ContextCompat.getColor(this@FourActivity, R.color.white)
                simplePagerTitleView.setOnClickListener { vp.currentItem = p1 }
                return simplePagerTitleView
            }
            ...
            override fun getIndicator(p0: Context?): IPagerIndicator? {
                val indicator = MyWrapPagerIndicator(this@FourActivity)
